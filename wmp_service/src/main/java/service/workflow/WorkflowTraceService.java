    ...
    private void setCurrentTaskAssignee(Map<String, Object> vars, Task currentTask) {
        ...
        if (assignee != null) {
        	...
        	if(assignee.contains(",")){
        		...
        		for(String single:assignees){
        			User assigneeUser = identityService.createUserQuery().userId(single).singleResult();
            		userInfo.append(assigneeUser.getFirstName() + " " + assigneeUser.getLastName());
            		userInfo.append(",");
        		}
